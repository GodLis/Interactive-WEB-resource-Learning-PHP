...
?>
    ...
    <div class="mypadding" style="text-align: justify">
        ...
        <div>
            ...
            <p>
                Імена масивів починаються зі знака <code>$</code>, після якого слід довільний ідентифікатор,
        ...
        <div>
            <p>
                ...
                звернутися до елементу масиву за його індексом і привласнити йому нового значення.
            </p>
            <p>
            ...
            <code>
                ...
                $arr[]  = "JQUERY";<br>
                <br>
                <b>foreach</b>($arr <b>as</b> $key => $value) { // при переборе: <b>$key</b> - индекс элемента массива,
                <b>$value</b> - значение элемента массива<br>
        ...
        <div>
            ...
            <p class="text-success">
                Також, щоб результат виведення функції <code>print_r</code> був більш наочним рекомендую перед
                використанням функції писати <code>echo "&lt;pre>"</code>, а після функції -
                <code>echo "&lt;/pre>"</code>. <b>Що таке тег pre?</b>
            </p>
            <p>
            ...
            <code>
                ...
                $arr[2] = "CSS";<br>
                <br>
                <b>foreach</b>($arr <b>as</b> $key => $value) { // <b>$key</b> - индекс элемента массива,
                <b>$value</b> - значение элемента массива<br>
        ...
        <div>
            <p>
                Для роботи з масивами в PHP передбачено дуже багато функцій, повний список яких перебувати нижче:
            </p>
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        Створює масив з двох заданих масивів - масиву індексів елементів і масиву значень
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Виконує сортування багатовимірного масиву або декількох одновимірних масиві
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Виробляє звернення масиву - перший елемент стає останнім, другий - передостаннім і т.д.
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        Шукає заданий елемент в масиві і повертає відповідним йому індек
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        Повертає перший елемент масиву, одночасно видаляючи його з масиву з Перенумерація числових
                        індексів
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        Вирізає з масиву подмассів заданої довжини, починаючи з зазначеного елемента
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Видаляє дублюються значення з масиву
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        Додає один або кілька елементів в початок масиву з Перенумерація числових індексів
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Створює масив із заданих значень або пар індекс - значенн
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Сортує масив по зростанню значень його елементів з Перенумерація його індексів
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Сортує масив по спадаючій значень його елементів з Перенумерація його індексів
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Перевіряє, чи присутній заданий значення в масиві
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <div>
            <p>
                ...
                по зростанню, по зменшенню і т. Д. У PHP для цього існує гідне кількість функцій, і в цьому уроці ми
        ...
        <div class="h1" style="text-align: center">
            Витяг змінних з масивів в PHP
        </div>
        <div>
            <p>
                Якщо є потреба для масиву, який проіндексованості малими даними , привласнити значення змінним ,
            ...
            <p>
                Якщо потрібно скласти з змінних масив, то потрібно використовувати функцію <code>compact</code>.
            </p>
            <code>
                &lt;?php<br>
                $one = "PHP";<br>
        ...
        <div>
            <p>
                ...
                суму всіх елементів масив, то можна скористатися функцією <code>array_sum</code>:
            </p>
            <code>
                &lt;?php<br>
                $arr[1] = 31;<br>
        ...
        <div>
            <p>
                ...
                який має інформацію про пропозиціях по роботі, від різних компаній:
            </p>
            <code>
                &lt;?php<br>
            ...
            <code>
                ...
                <br>
                // можете используйте тег pre для форматирования вывода<br>
                <b>echo</b> "&lt;pre>";<br>
                print_r($companies);<br>
                <b>echo</b> "&lt;/pre>";<br>
                ?>
        ...
        <div>
            <p>
                ...
                цикли . Ми також можемо використовувати цикли і для багатовимірних масивів, тільки потрібно трошки
            ...
            <p>
                Мінлива <code>$i</code> відповідає за рахунок в перших квадратних дужках масиву,
                а змінна <code>$j</code> за рахунок по-друге квадратних дужках масиву.
                Другий цикл <b>FOR</b> працює, поки в масиві не закінчаться елементи певного індексу.
            </p>
        </div>

        <div class="h1" style="text-align: center">
            Оператори над масивами в PHP
        </div>
        <div>
            <p>
