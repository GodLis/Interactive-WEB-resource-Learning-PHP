...
<div class="mypadding" style="text-align: justify">
    ...
    <div>
        <p>
            Починаючи з цього уроку ми з вами відкриваємо главу присвячену функцій для обробки строкових даних.
        </p>
        <p>
            За допомогою цих фукнции можна, наприклад, обрізати рядок, дописувати рядок, замінити частину рядка
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    Розбиває рядок на підрядка заданої довжини
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Виводить одну або кілька рядків
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    Розбиває рядок на підрядка, обмежені заданим роздільником, і форматує з них масив
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    Декодує все HTML-вистави в відповідні символи. Функція назад по відношенню до htmlentites
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Являє число у вигляді рядка в різних форматах
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Розбиває рядок URL і привласнює значення змінним
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Встановлює інформацію про кодової сторінці
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Шукає в рядку всі входження підрядка і змінює на задану рядок
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Шукає перше входження підрядка в рядку без урахування регістру символів
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Шукає перше входження підрядка в рядку
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    Шукає останнє входження символу в рядку
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    Інвертує рядок - прочитує її справа наліво
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    Шукає останнє входження підрядка в рядку без урахування регістру символів
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    Шукає останнє входження підрядка в рядку
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    Підраховує, скільки разів задана подстрока зустрічається в рядку
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    Шукає в заданій ділянці рядки все входження підрядка і змінює на інший рядок
                </td>
            </tr>
            <tr>
                <td>
    ...
    <div>
        <p>
            У цьому уроці ми подивимося як використовувати кілька строкових функцій для обробки тексту.
        </p>
        ...
        <div>
            ...
            <p>
                Перший параметр <code>$string</code> - рядок з якої потрібно отримати підрядок починаючи з позиції
            ...
            <p>
                Якщо <code>$start</code> негативний, то повертається підрядок матиме значення від кінця рядка до
        ...
        <div>
            ...
            <p>
                Перший параметр <code>$string</code> - рядок в якій буде проведений пошук, <code>$needle</code>
            ...
            <code>
                &lt;?php<br>
                echo strpos("Hello world", "world"); // получим 6<br>
                ?>
            </code>
            <p>
