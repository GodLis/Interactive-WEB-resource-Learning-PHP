...
<div class="mypadding" style="text-align: justify">
    ...
    <div>
        PHP-код ОБОВ'ЯЗКОВО слід укладати в повну версію ( &lt;? Php?> ) Тегів вкорочений (скорочену запис echo) версію
    ...
    <div>
        ...
        ефектів (наприклад: передавати дані в вихідний потік, модифікувати настройки і т.п.), або реалізовувати
        ...
        породження винятків, зміна глобальних або локальних змінних, читання з файлу або запис в файл і т .п.
        <br>
    ...
    <div>
        ...
        <br>
        У коді, написаному для PHP 5.2.x і нижче, СЛІД при іменуванні класів дотримуватися угоди про псевдопространствах
    ...
    <div>
        У цьому посібнику навмисно не наводиться жодних рекомендацій щодо використання $ StudlyCaps , $ camelCase
    ...
    <div>
        Імена методів ПОВИННІ бути оголошені з використанням т.зв. « CamelCase » (перше слово пишеться в нижньому
