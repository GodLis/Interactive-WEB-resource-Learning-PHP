...
<div class="mypadding" style="text-align: justify">
    ...
    <div>
        ...
        <p>
            <b>/</b> частка від ділення двох чисел
        </p>
        <p>
    ...
    <div>
        ...
        <p>
            Оператор <code>++</code> називають инкрементом, а <code>--</code> декрементом.
        </p>
        <p>
    ...
    <div>
        ...
        <p>
            Будь-яка рядок, яка укладена в зворотні апострофи - `вважаються як команда ОС. наприклад:
        </p>
        <code>
            &lt;?php<br>
            $d = `dir d:\\`;<br>
    ...
    <div>
        ...
        <p>
            <b>Перший</b> - оператор конкатенації ., який об'єднує два рядки в одну.
        </p>
        <p>
        ...
        <code>
            &lt;?php<br>
            $d = "Hello";<br>
            $f = $d." world";   // Теперь $f = "Hello world"<br>
            <br>
            echo $f;<br>
            <br>
            echo "<br/>";<br>
            <br>
            $f .= " ! ! !";   // Теперь $f = "Hello world ! ! !"<br>
            <br>
            echo $f;<br>
            ?>
        </code>
