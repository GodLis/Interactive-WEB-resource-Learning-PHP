    ...
    <div>
        ...
        <div>
            <ul>
                <li>
                    <code>
                        \ namespace \ package \ Class_Name => /path/to/project/lib/vendor/namespace/package/Class/
                        Name.php
                    </code>
                </li>
                <li>
                    <code>
                        \ namespace \ package_name \ Class_Name => /path/to/project/lib/vendor/namespace/package_name/
                        Class
                        /Name.php
                    </code>
                </li>
            ...
            <p>
                ...
                скориставшись наступним прикладом реалізації SplClassLoader (орієнтований на завантаження класів PHP
                5.3).
            </p>
        </div>
        ...
        <div>
            <p>
                Нижче представлений приклад функції, яка ілюструє, як описані вище вимоги впливають на процес
                автозавантаження:
            </p>
            <code>
                &lt;?php<br>
