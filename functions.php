    ...
    <div class="mypadding" style="text-align: justify">
        ...
        <div>
            ...
            <p>
                ...
                У нашому випадку, функція задає змінній <code>$square</code> квадрат числа,
            ...
            <p>
                ...
                <code>square(яке-небудь число)</code>;
            </p>
            <p>
        ...
        <div>
            ...
            <p>
                ...
                Тобто в нашому разі ми порахували потрібнтй нам вираз,
        ...
        <div>
            ...
            <p>
                Ця функція буде виводити будь-який текст, який буде переданий їй як аргумент.
            ...
            <code>
                &lt;?php<br>
                function hello($text = "Привіт") {<br>
                    echo $text;<br>
                }<br>
                <br>
                hello('Добрмй день');<br>
                <br>
                echo "&lt;br/>";<br>
                <br>
                hello();<br>
            ...
            <p>
                Перший виклик функції <code>hello('Добрій день')</code> виведе: <i>"Добрий день"</i>,
