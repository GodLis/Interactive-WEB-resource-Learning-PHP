    ...
    <div class="mypadding" style="text-align: justify">
        ...
        <div>
            <p>
                ...
                фігурних дужок, усередині яких можна визначати властивості і методи (буде розглянуто) цього класу.
            </p>
            <p>
                Іменем класу може бути будь-яке слово, за умови, що воно не входить в список зарезервованих
                слів PHP , починається з
                букви або символу підкреслення і за яким слід будь-яку кількість букв, цифр або символів підкреслення.
            </p>
            <code>
                &lt;?php<br>
                class FirstClass<br>
        ...
        <div>
            ...
            <code>
                ...
                <br>
                // Это можно сделать и с помощью переменной:<br>
        ...
        <div>
            ...
            <code>
                ...
                <br>
                $instance = new FirstClass(); // вернет строку "hi"<br>
                $instance = new FirstClass("hello"); // вернет строку "hello"<br>
                ?>
            </code>
            <p>
                Також, в PHP представлені <b>деструктори</b>. Деструкція буде викликаний при звільненні всіх посилань
        ...
        <div>
            ...
            <p>
                ...
                і покажчика $ this, наприклад $ this-> var1 (де var1 - ім'я змінної) або $ this-> firstFunction ()
                (де, firstFunction - ім'я методу).
            </p>
            <p>
                приклад:
            </p>
            <code>
                ...
                $instance =  new FirstClass();<br>
                <br>
                $instance->setVar1("orange"); // установим значение "orange" для переменной var1<br>
                ?>
            </code>
        </div>
        ...
        <div>
            ...
            <p>
                Значення має бути незмінним виразом, що не властивістю, або викликом функції.
            </p>
            ...
            <code>
                ...
                <br>
                // доступ к константе<br>
                echo FirstClass:: CONSTANT;<br>
                <br>
                // через метод в классе<br>
                class FirstClass {<br>
        ...
        <div>
            <p>
                У попередньому уроці ми могли використовувати ключове слово public перед змінної або класом.
            ...
            <code>
                ...
                $instance = new FirstClass();<br>
                <br>
                $instance->var1; // работает<br>
                $instance->func1(); // работает, результат: public private protected<br>
                $instance->var2; // ошибка<br>
                $instance->var3; // ошибка<br>
                $instance->func2(); // ошибка<br>
                $instance->func3(); // ошибка<br>
                <br>
                ?>
            </code>
            <p class="text-warning">
                Методи, де визначення області видимості відсутня, визначаються як public.
            </p>
        </div>
        ...
        <div>
            ...
            <code>
                &lt;?php<br>
                $sc->func1(); // не работает, метод защищен (protected)<br>
                ?>
            </code>
        </div>
        ...
        <div>
            ...
            <code>
                ...
                abstract class AbstClass {<br>
                    /* Данный метод должен быть определён в дочернем классе */<br>
        ...
        <div>
            ...
            <code>
                ...
                <br>
                FirstClass::myStaticMethod(); // вызов метода<br>
                ?>
            </code>
        </div>
        ...
        <div>
            ...
            <code>
                &lt;?php<br>
                // Объявим интерфейс 'CarTemplate'<br>
                interface CarTemplate<br>
                {<br>
                    public function getId(); // получить id автомобиля<br>
                    public function getName(); // получить название<br>
                    public function add(); // добавить новый автомобиль<br>
                }<br>
                ?>
            </code>
            <p>
                ...
                більш одного інтерфейсу, реалізовані інтерфейси повинні розділятися комою.
            </p>
            <p>
                приклад:
            </p>
        ...
        <div>
            <p>
                ...
                Такі методи і властивості обробляються за допомогою "чарівних" методів, які можна створити в класі
            ...
            <div>
                <p>
                    ...
                    якщо об'єкт не містить властивості, до якого здійснюється доступ. синтаксис:
                </p>
                <pre>
                    &lt;?php
                ...
                <code>
                    ...
                    <br>
                    $obj = new MyClass;<br>
                    $obj->a = 1; // запись в свойство (свойство не существует)<br>
                    echo $obj->b; // получаем значение свойства (свойство не существует)<br>
                    echo $obj->c; // получаем значение свойства (свойство существует)<br>
                    ?>
                </code>
                <p>
                    результат:
            ...
            <div>
                ...
                <code>
                    ...
                    <br>
                    $obj = new MyClass;<br>
                    echo $obj->getName(); // вызов метода (метод не существует)<br>
                    echo $obj->getId(); // вызов метода (метод не существует)<br>
                    ?>
                </code>
                <p>
                    результат:
                ...
                <blockquote>
                    __call, method - getName is not exists (при вызове getName)<br>
        ...
        <div>
            ...
            <code>
                ...
                echo $obj->names($names); // работает<br>
                <br>
                $names = "Олег Симонов";<br>
                <br>
                // получим фатальную ошибку: Argument 1 passed to MyClass::names() must be of the type array,
                string given<br>
                echo $obj->names($names);<br>
                <br>
                // получим фатальную ошибку: Argument 1 passed to MyClass::names() must be an instance of
        ...
        <div>
            <p>
                Простору імен, це один із способів інкапсуляції елементів. Таке абстрактне поняття можна побачити в
                багатьох місцях. Наприклад, в операційній системі директорії служать для угруповання файлів і
                виступають в якості простору імен для знаходяться в них файлів. Як приклад файл text.txt може
            ...
            <ul>
                ...
                <li>
                    ...
                    проблему і поліпшити читаність вихідного коду.
                </li>
            </ul>
            <p>
                Приклад використання.
            ...
            <p>
                За допомогою достатньо міс імен ми можемо отримати доступ до класу
        ...
        <div class="h1" style="text-align: center">
            Створення псеводіма імені
        </div>
        <div>
            <p>
                Псевдоніми для пространст імен іспользуються для більш просто доступу до потрібного простору.
        ...
        <div>
            ...
            <div>
                <p>
                    Розглянемо приклад використання трейта на основі створення "транслітератор"
                ...
                <code>
                    ...
                    <br>
                        public function translate($str) {<br>
                            // заменяем символы кириллицы на символы латиницы<br>
                    ...
                    <br>
                        /**<br>
                         *	Некая функция для добавления данных в наш массив<br>
                         */<br>
                    ...
                    <br>
                        /**<br>
                         *	 Некая фукнция для подготовки данных<br>
                         */<br>
                        public function getPreparedData() {<br>
                            // допустим, мы хотим сделать адрес страницы по названию<br>
                            // тогда, нам нужно перевести название с кириллическими символами на латиницу<br>
                    ...
                    <br>
                    $obj->setData([<br>
                        'title' => 'Не очень простое название для страницы',<br>
                        'content' => 'Текст страницы'<br>
                    ]);<br>
                    <br>
                ...
                <blockquote>
                    ...
                    [title] => Не очень простое название для страницы<br>
                    [content] => Текст страницы<br>
                    [url] => ne_ochen_prostoe_nazvanie_dlya_stranicy<br>
                    )
                </blockquote>
            </div>
        </div>
