...
?>
    ...
    <div class="mypadding" style="text-align: justify">
        ...
        <div>
            <p>
                У цьому уроки ми з допомогою функцій PHP отримаємо дані, які буде вводити користувач в форму.
            </p>
            <p>
            ...
            <p>
                Зверніть увагу на рядок <b>action = "app / check.php"</b> - це адреса
                обробника форми, сюди будуть відправлятися дані форми, після натискання кнопки Надіслати.
            ...
            <p>
                1. Давайте почнемо.
                Створіть і відкрийте (через редактор) обробник app / code.php - спочатку,
            ...
            <p>
                ...
                для цього, який-небуть змінної присвоюємо отримане значення від цього поля, наприклад:
            </p>
            <code>
                <\&lt;?php<br>
                $name = $_POST['name'];<br>
        ...
        <div>
            ...
            <ol>
                ...
                <li>
                    <p>
                        ...
                        створимо нескольно функцій для перевірки.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        ( "Ваc звуть O \ 'reilly?" => "Вас звати O'reilly?").
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        Перший параметр, <code>$value</code> це рядок, яку потрібно перевірити,
            ...
            <p>
                Якщо все сталося успішно, то ми побачимо повідомлення <i>"Дякуємо за повідомлення"</i>
            </p>
            <p class="text-warning">
